...
<div>
    <div class="faqs-w3l">
        <div class="container">
            ...
            <c:if test="${logisticss==null}">

                <h2 class="tittle-w3l">您暂无订单</h2>

            </c:if>
            <c:forEach items="${logisticss}" var="wl">
                    ...
                    <ul class="layui-timeline">
                        <div class="container">
                            <ul class="w3_short">
                                ...
                                <li><a href="orderForm?oid=${logistics.oid}">: ${wl.oid}</a></li>
                            </ul>
                        </div>
                        ...
                        <li class="layui-timeline-item">
                            ...
                            <div class="layui-timeline-content layui-text">
                                ...
                                <ul>
                                    ...
                                    <c:if test="${wl.status==1}"><fmt:formatDate value="${wl.endTime}"

...
<div class="privacy">
    <div class="container">
        ...
        <h4 class="tittle-w3l">You Should Pay
                ...
                <div class="resp-tabs-container hor_1">
                    ...
                    <div>
                        <div class="vertical_post check_box_agile">
                            ...
                            <form action="paystaus" method="post">

                                <input type="hidden" name="fdids" value="${fdid}">
                                <input type="hidden" name="payType" value="1"/>
                                <input type="hidden" name="totalPrice" value="${totalPrice}">
                                <input type="submit" class="submit" value="Make a payment">
                            </form>
                        </div>
                    </div>
                    <div>
                        ...
                        <div id="tab4" class="tab-grid" style="display: block;">
                            <div class="row">
                                ...
                                <div class="col-md-6 number-paymk">
                                    <form class="cc-form" method="post" action="paystaus">
                                        <div class="clearfix">

        ...
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-sub_agile">
                ...
                <div class="modal_body_left modal_body_left1">
                    ...
                    <form action="uesrLogin" method="post">
                ...
                <ul class="layui-timeline">
                    <div class="container">
                        <ul class="w3_short">
                            ...
                            <li><a href="orderForm?oid=${logistics.oid}">: ${logistics.oid}</a></li>
                        </ul>
                    </div>
                    <li class="layui-timeline-item">
                        <i class="layui-icon layui-timeline-axis">&#xe63f;</i>
                        <div class="layui-timeline-content layui-text">
                            <h3 class="layui-timeline-title">打包时间</h3>

                            <ul>
                                <fmt:formatDate value="${logistics.packageTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
                    ...
                    <li class="layui-timeline-item">
                        ...
                        <div class="layui-timeline-content layui-text">
                            ...
                            <ul>
                                <fmt:formatDate value="${logistics.payTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
                            </ul>
                        </div>
                    </li>
                    <li class="layui-timeline-item">
                        ...
                        <div class="layui-timeline-content layui-text">
                            ...
                            <ul>
                                <fmt:formatDate value="${logistics.beginTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
                            </ul>
                        </div>
                    </li>
                    <li class="layui-timeline-item">
                        ...
                        <div class="layui-timeline-content layui-text">
                            ...
                            <h3 class="layui-timeline-title">
                                <c:if test="${logistics.status==0}">配送中</c:if>
                                <c:if test="${logistics.status==1}">配送结束时间</c:if>
                            </h3>
                            <ul>
                                <c:if test="${logistics.status==0}">您的东西还在路上，请耐心等待</c:if>
                                <c:if test="${logistics.status==1}"><fmt:formatDate value="${logistics.endTime}"

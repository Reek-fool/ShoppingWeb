                ...
                <div class="checkout-right">
                    ...
                    <div class="table-responsive">
                        <table class="timetable_sub">
                            ...
                            <tbody class="cart1">
                            <c:forEach items="${orderForm}" var="cart" varStatus="count">
                                <tr>
                                    <th>&nbsp;${count.count}</th>
                                    <th>&nbsp;<a style="color: #0000FF"
                                                 href="getGoodDetailsByFdid?fdid=${cart.fdid}">${cart.goodName}</a></th>
                                    <th>&nbsp;$${cart.price*cart.discount/100}</th>
                                    <th>&nbsp;${cart.count/(cart.price*cart.discount/100)}</th>
                                    <th>&nbsp;
                                        <c:if test="${cart.preference==1}">肉食</c:if>
                                        <c:if test="${cart.preference==2}">素食</c:if>
                                        <c:if test="${cart.preference==0}">其他</c:if>
                                    </th>
                                    <th>
                                        &nbsp;$${cart.count}</th>
                                </tr>
